...
contract RewardEscrow is Owned, IRewardEscrow {
     ...
     * These are the times at which each given quantity of MNA vests. */
    mapping(address => uint[2][]) public vestingSchedules;

    /* An account's total escrowed synthetix balance to save recomputing this for fee extraction purposes. */
    mapping(address => uint) public totalEscrowedAccountBalance;

    /* An account's total vested reward moneta. */
    mapping(address => uint) public totalVestedAccountBalance;

    /* The total remaining escrowed balance, for verifying the actual moneta balance of this contract against. */
    ...
    /**
     * @notice set the synthetix contract address as we need to transfer MNA when the user vests
     */
     ...
     * @return A pair of uints: (timestamp, mna quantity).
     */
    ...
    /**
     * @notice Get the quantity of MNA associated with a given schedule entry.
     */
