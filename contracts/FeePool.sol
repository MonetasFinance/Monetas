...
contract FeePool is Owned, Proxyable, SelfDestructible, LimitedSetup, MixinResolver, MixinSystemSettings, IFeePool {
     ...
     * @dev onlyIssuer to call me on synthetix.issue() & synthetix.burn() calls to store the locked MNA
    ...
    /**
     * @notice The RewardsDistribution contract informs us how many MNA rewards are sent to RewardEscrow to be claimed.
     */
    function setRewardsToDistribute(uint amount) external {
        ...
        // Add the amount of MNA rewards to distribute on top of any rolling unclaimed amount
    ...
    /**
     * @notice Owner can escrow MNA. Owner to send the tokens to the RewardEscrow
    ...
    function appendVestingEntry(address account, uint quantity) public optionalProxy_onlyOwner {
        // Transfer MNA from messageSender to the Reward Escrow
     ...
     * @param snxAmount The amount of MNA tokens.
     */
    ...
    /**
     * @notice The total MNA rewards available in the system to be withdrawn
     */
     ...
     * @dev Returns two amounts, one for fees and one for MNA rewards
     */
    function feesAvailable(address account) public view returns (uint, uint) {
        ...
        // Return totalRewards as is in MNA amount
